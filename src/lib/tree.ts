...
export const TREE_STAGES: TreeStage[] = [
    ...
    { id: 'sacred', name: 'ต้นไม้ศักดิ์สิทธิ์', minMinutes: 6000, maxMinutes: 9999, symbol: '✨🌳✨', description: 'สัญลักษณ์แห่งปัญญาและการเชื่อมโยงอันลึกซึ้ง' },
    { id: 'clarity', name: 'ต้นไม้แห่งความกระจ่าง', minMinutes: 10000, maxMinutes: 19999, symbol: '⚪🌳', description: 'จิตใจเริ่มใสบริสุทธิ์เหมือนหยาดน้ำค้าง' },
    { id: 'bodhi', name: 'มหาโพธิ์แห่งปัญญา', minMinutes: 20000, maxMinutes: 39999, symbol: '🧘🌳', description: 'การตระหนักรู้เริ่มหยั่งรากลึกเกินกว่าโลกภายนอก' },
    { id: 'crystal', name: 'ต้นไม้หัวใจเพชร', minMinutes: 40000, maxMinutes: 69999, symbol: '💎🌳', description: 'จิตใจมั่นคงและบริสุทธิ์ประดุจเพชรที่เจียระไนแล้ว' },
    { id: 'golden', name: 'พฤกษารัศมีทอง', minMinutes: 70000, maxMinutes: 109999, symbol: '🟡🌳', description: 'แผ่เมตตาและพลังบวกออกสู่ทุกสรรพสิ่ง' },
    { id: 'lotus', name: 'ต้นบัวสถิตวิญญาณ', minMinutes: 110000, maxMinutes: 169999, symbol: '🪷🌳', description: 'ความสงบภายในที่เบ่งบานอยู่เหนือกิเลสทั้งปวง' },
    { id: 'phoenix', name: 'สนฟีนิกซ์นิรันดร์', minMinutes: 170000, maxMinutes: 249999, symbol: '🔥🌲', description: 'การเกิดใหม่ของจิตวิญญาณที่ไม่มีวันดับสูญ' },
    { id: 'celestial', name: 'ผู้พิทักษ์ดาราจักร', minMinutes: 250000, maxMinutes: 349999, symbol: '🌌🌿', description: 'จิตเชื่อมโยงกับจังหวะของดวงดาวและจักรวาล' },
    { id: 'infinity', name: 'รากเหง้าไร้กาลเวลา', minMinutes: 350000, maxMinutes: 499999, symbol: '♾️🌳', description: 'การดำรงอยู่เหนือกาลเวลาและสถานที่' },
    { id: 'divine', name: 'มหาพฤกษาแสงทิพย์', minMinutes: 500000, maxMinutes: 749999, symbol: '☀️🌳', description: 'กลายเป็นหนึ่งเดียวกับแสงสว่างแห่งปัญญาขั้นสูง' },
    { id: 'universal', name: 'หัวใจแห่งเอกภพ', minMinutes: 750000, maxMinutes: Infinity, symbol: '✨🌌🧘✨', description: 'สัจธรรมสูงสุด: ความว่างที่เป็นทุกสรรพสิ่ง' },
];
