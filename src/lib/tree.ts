...
export const TREE_STAGES: TreeStage[] = [
    ...
    { id: 'fruitful', name: 'ต้นไม้ติดผล', minMinutes: 3000, maxMinutes: 3499, symbol: '🍎', description: 'ให้ผลแก่ผู้อื่น' },
    { id: 'ancient', name: 'ต้นไม้โบราณ', minMinutes: 3500, maxMinutes: 3999, symbol: '🌳🏔️', description: 'ภูมิปัญญาแห่งกาลเวลา' },
    { id: 'sacred', name: 'ต้นไม้ศักดิ์สิทธิ์', minMinutes: 4000, maxMinutes: 4499, symbol: '✨🌳✨', description: 'สัญลักษณ์แห่งปัญญาและการเชื่อมโยงอันลึกซึ้ง' },
    { id: 'clarity', name: 'ต้นไม้แห่งความกระจ่าง', minMinutes: 4500, maxMinutes: 6499, symbol: '⚪🌳', description: 'จิตใจเริ่มใสบริสุทธิ์เหมือนหยาดน้ำค้าง' },
    { id: 'bodhi', name: 'มหาโพธิ์แห่งปัญญา', minMinutes: 6500, maxMinutes: 8499, symbol: '🧘🌳', description: 'การตระหนักรู้เริ่มหยั่งรากลึกเกินกว่าโลกภายนอก' },
    { id: 'crystal', name: 'ต้นไม้หัวใจเพชร', minMinutes: 8500, maxMinutes: 10499, symbol: '💎🌳', description: 'จิตใจมั่นคงและบริสุทธิ์ประดุจเพชรที่เจียระไนแล้ว' },
    { id: 'golden', name: 'พฤกษารัศมีทอง', minMinutes: 10500, maxMinutes: 12499, symbol: '🟡🌳', description: 'แผ่เมตตาและพลังบวกออกสู่ทุกสรรพสิ่ง' },
    { id: 'lotus', name: 'ต้นบัวสถิตวิญญาณ', minMinutes: 12500, maxMinutes: 14499, symbol: '🪷🌳', description: 'ความสงบภายในที่เบ่งบานอยู่เหนือกิเลสทั้งปวง' },
    { id: 'phoenix', name: 'สนฟีนิกซ์นิรันดร์', minMinutes: 14500, maxMinutes: 16499, symbol: '🔥🌲', description: 'การเกิดใหม่ของจิตวิญญาณที่ไม่มีวันดับสูญ' },
    { id: 'celestial', name: 'ผู้พิทักษ์ดาราจักร', minMinutes: 16500, maxMinutes: 18499, symbol: '🌌🌿', description: 'จิตเชื่อมโยงกับจังหวะของดวงดาวและจักรวาล' },
    { id: 'infinity', name: 'รากเหง้าไร้กาลเวลา', minMinutes: 18500, maxMinutes: 20499, symbol: '♾️🌳', description: 'การดำรงอยู่เหนือกาลเวลาและสถานที่' },
    { id: 'divine', name: 'มหาพฤกษาแสงทิพย์', minMinutes: 20500, maxMinutes: 22499, symbol: '☀️🌳', description: 'กลายเป็นหนึ่งเดียวกับแสงสว่างแห่งปัญญาขั้นสูง' },
    { id: 'universal', name: 'หัวใจแห่งเอกภพ', minMinutes: 22500, maxMinutes: Infinity, symbol: '✨🌌🧘✨', description: 'สัจธรรมสูงสุด: ความว่างที่เป็นทุกสรรพสิ่ง' },
];
