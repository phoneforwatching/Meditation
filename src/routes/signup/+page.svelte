...
<div class="max-w-md mx-auto py-12">
  <div class="text-center mb-8">
    ...
    <h1 class="text-3xl font-bold text-sage">Begin Your Journey</h1>
    <p class="text-slate/60">Plant your seed today</p>
  </div>
  ...
  <p class="text-center mt-6 text-slate/60">
    Already have a tree? <a
      href="/login"
      class="text-sage font-semibold hover:underline">Log in</a
    >
  </p>
</div>
